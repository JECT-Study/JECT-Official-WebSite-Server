...
public class CustomSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        String accessToken = jwtTokenProvider.createAccessToken(authentication, customUserDetails.getApplicantId());
        String refreshToken = jwtTokenProvider.createRefreshToken(authentication, customUserDetails.getApplicantId());
     ...
     */
    public void onAuthenticationSuccess(HttpServletResponse response, String refreshToken, Long applicantId) {
        String newAccessToken = jwtTokenProvider.reissueAccessToken(refreshToken, applicantId);
